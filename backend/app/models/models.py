...
class Workspace(Base):
    ...
    tenant_id: Mapped[str] = mapped_column(String(50), nullable=False, server_default="tenant-a")
...
class Message(Base):
    ...
    sources: Mapped[Optional[dict]] = mapped_column(SQLiteJSON, nullable=True)
